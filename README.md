...
- **Optional live backend** (`worker.js` + `SETUP_GUIDE.md`): a free Cloudflare Worker that auto-refreshes Nifty/USD-INR/Brent/US 10Y and pulls live headlines from free RSS feeds every 30 minutes. The six analysis "stories" stay manually refreshed via Claude — see SETUP_GUIDE.md for why and what's automated vs. not.
